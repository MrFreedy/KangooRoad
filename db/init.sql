...
INSERT INTO public.feedbacks (id, form_data, is_visible, submission_date, school, year, city, country, user_type, is_contact, firstname, lastname, email) VALUES (16, '[{"questions": []}]', true, '2025-02-23', 'Université de Tartu', 2024, 'Tartu', 'Estonie', 'alternant', true, 'Thomas', 'Bernard', 'thomas.bernard@hotmail.fr');
INSERT INTO public.feedbacks (id, form_data, is_visible, submission_date, school, year, city, country, user_type, is_contact, firstname, lastname, email) VALUES (9, '[{"questions": []}]', true, '2024-11-27', 'UQAC', 2024, 'Chicoutimi', 'Canada', 'alternant', true, 'Julien', 'Martin', 'julien.martin.12@gmail.com');
INSERT INTO public.feedbacks (id, form_data, is_visible, submission_date, school, year, city, country, user_type, is_contact, firstname, lastname, email) VALUES (13, '[{"questions": []}]', true, '2025-02-13', 'UQO', 2023, 'Gatineau', 'Canada', 'alternant', true, 'Sophie', 'Leroy', 'sophie.leroy.pro@gmail.com');
INSERT INTO public.feedbacks (id, form_data, is_visible, submission_date, school, year, city, country, user_type, is_contact, firstname, lastname, email) VALUES (11, '[{"questions": []}]', true, '2025-01-28', 'UHU Huelva', 2022, 'Huelva', 'Espagne', 'alternant', true, 'Camille', 'Moreau', 'moreau.camille98@gmail.com');
...
INSERT INTO public.feedbacks (id, form_data, is_visible, submission_date, school, year, city, country, user_type, is_contact, firstname, lastname, email) VALUES (8, '[{"questions": []}]', true, '2024-11-26', 'UPB', 2022, 'Bucarest', 'Roumanie', 'alternant', true, 'Antoine', 'Petit', 'petit.antoine.pro@gmail.com');
INSERT INTO public.feedbacks (id, form_data, is_visible, submission_date, school, year, city, country, user_type, is_contact, firstname, lastname, email) VALUES (14, '[{"questions": []}]', true, '2025-02-22', 'UTS Sofia', 2024, 'Sofia', 'Bulgarie', 'alternant', true, 'Hugo', 'Lambert', 'hugolam64@gmail.com');
...
INSERT INTO public.feedbacks (id, form_data, is_visible, submission_date, school, year, city, country, user_type, is_contact, firstname, lastname, email) VALUES (12, '[{"questions": []}]', true, '2025-01-30', 'Université de Maribor', 2023, 'Maribor', 'Slovénie', 'alternant', true, 'Léa', 'Simon', 'simon.lea@gmail.com');
INSERT INTO public.feedbacks (id, form_data, is_visible, submission_date, school, year, city, country, user_type, is_contact, firstname, lastname, email) VALUES (18, '[{"questions": []}]', true, '2025-04-01', 'Riga Technical University', 2024, 'Riga', 'Lettonie', 'alternant', true, 'Maxime', 'Girard', 'girard.maxime@gmail.com');
INSERT INTO public.feedbacks (id, form_data, is_visible, submission_date, school, year, city, country, user_type, is_contact, firstname, lastname, email) VALUES (3, '[{"questions": []}]', true, '2024-11-21', 'UQAC', 2023, 'Chicoutimi', 'Canada', 'alternant', true, 'Elisa', 'Rousseau', 'elisa.rousseau0@gmail.com');
...
INSERT INTO public.feedbacks (id, form_data, is_visible, submission_date, school, year, city, country, user_type, is_contact, firstname, lastname, email) VALUES (4, '[{"questions": []}]', true, '2024-11-21', 'UQAC', 2024, 'Chicoutimi', 'Canada', 'alternant', true, 'Pierre', 'Fontaine', 'fontainep@gmail.com');
INSERT INTO public.feedbacks (id, form_data, is_visible, submission_date, school, year, city, country, user_type, is_contact, firstname, lastname, email) VALUES (2, '[{"questions": []}]', true, '2024-11-14', 'UQO', 2023, 'Gatineau', 'Canada', 'alternant', true, 'Clara', 'Mercier', 'clara.mercier@protonmail.com');
